...
- Remote Desktop Protocol (RDP)
  ...
  2. Configured Log Analytics to ingest Windows Secuirty Event Logs
  ...
  6. Documented attacker IPs, geolocations, and pluged inSentinel to show global map for attacks.
